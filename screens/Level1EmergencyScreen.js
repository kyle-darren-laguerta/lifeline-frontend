          ...
          {routineReasons.map((item) => (
            ...
            >
              <MaterialCommunityIcons 
                name={item.icon} 
                size={24} 
                color={reason === item.label ? '#2E7D32' : '#666'} 
              />
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#4CAF50', padding: 30, paddingTop: 50 },
  ...
  selectedItem: { borderColor: '#4CAF50', backgroundColor: '#E8F5E9' },
  ...
  saveButton: { backgroundColor: '#2E7D32', padding: 20, alignItems: 'center' },
  saveButtonText: { color: 'white', fontWeight: 'bold', fontSize: 16 }
});

export default Level1RoutineScreen;